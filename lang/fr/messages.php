...
/*
 * ============================================================
 *  lang/fr/messages.php — French System Messages Translations
 * ============================================================
 */
return [
    /* ── Success ── */
    ...
    'review_submitted'     => 'Avis soumis. Merci !',
    ...
    'expired_code'         => 'Code expiré. Veuillez renvoyer.',
    'already_registered'   => 'Cet email est déjà enregistré.',
    'out_of_stock'         => 'Désolé, ce produit est actuellement indisponible.',
    'cart_empty'           => 'Votre panier est vide.',
    'login_required'       => 'Vous devez être connectée.',
    'delete_failed'        => 'Suppression échouée. Veuillez réessayer.',
    'upload_failed'        => 'Téléchargement échoué.',
    'max_file_size'        => 'Taille de fichier dépassée.',
    ...
    'maintenance'          => 'Le site est en maintenance.',
