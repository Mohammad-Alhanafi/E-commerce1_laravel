...
/*
 * ============================================================
 *  lang/en/messages.php — English System Messages Translations
 * ============================================================
 */
return [
    /* ── Success ── */
    ...
    'expired_code'         => 'Code expired. Please resend.',
    'already_registered'   => 'Email is already registered.',
    'out_of_stock'         => 'Sorry, this product is currently unavailable.',
    'cart_empty'           => 'Your cart is empty.',
    'login_required'       => 'You must be logged in first.',
    'delete_failed'        => 'Delete failed. Please try again.',
    'upload_failed'        => 'Upload failed. Check format and size.',
    'max_file_size'        => 'File size exceeds the allowed limit.',
